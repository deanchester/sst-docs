...
public:
    ...
    SST_ELI_REGISTER_MODULE(
        ...
        "exampleLibrary",               // Library name, the 'lib' in SST's lib.name format
        "mymodule",                     // // Name used to refer to this module, the 'name' in SST's lib.name format
