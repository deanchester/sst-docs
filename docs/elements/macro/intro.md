...
Macro includes [user](https://github.com/sstsimulator/sst-macro/blob/v16.0.0_beta/docs/manual/manual.md) and [developer](https://github.com/sstsimulator/sst-macro/blob/v16.0.0_beta/docs/developer/developer.md) guides. 
